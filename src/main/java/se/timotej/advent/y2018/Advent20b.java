...
public class Advent20b {
    ...
    public static void main(String[] args) throws IOException {
        String svar = new Advent20b().calc(Online.get());
    ...
    private String calc(List<String> strs) {
        ...
        while (!goQ.isEmpty()) {
            ...
            if (next != null) {
                ...
                if (str[pos] == '(') {
                    List<Integer> starts = findStarts(pos);
                    ...
                    goQ.add(Pair.of(getNextSlutParentes(pos), here));
                }
            }
        }
        ...
        long svar = dist.values().stream().filter(i -> i>= 1000).count();
