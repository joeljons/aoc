...
public class Online {
    ...
    public static List<String> getToday() throws IOException {
        ...
        while (cal.get(Calendar.HOUR) < 6) {
            slept = true;
            System.out.println(String.format("Zzz %02d:%02d:%02d", cal.get(Calendar.HOUR), cal.get(Calendar.MINUTE),
    ...
    public static List<String> get(int day) throws IOException {
        Path path = Paths.get("input_2019_" + day + ".txt");
        if (!path.toFile().exists()) {
            URL url = new URL("https://adventofcode.com/2019/day/" + day + "/input");
    ...
    public static List<String> get(int day, String suffix) throws IOException {
        Path path = Paths.get("input_2019_" + day + suffix + ".txt");
        return Files.readAllLines(path);
    }
    ...
    public static boolean submit(int day, int level, String answer) {
        ...
        try {
            ...
            do {
                ...
                URL url = new URL("https://adventofcode.com/2019/day/" + day + "/answer");
                URLConnection urlConnection = url.openConnection();
