...
public class Advent22b {
    ...
    private Queue<State> q = new ArrayDeque<>();
    private int leastManaWon = Integer.MAX_VALUE;

    private int calc(List<String> strs) {
        State start = new State(50-1, 500, 0, OPPONENT_HP, 0, 0, 0);
        q.add(start);
    ...
    private class State {
        ...
        State(int myHP, int mana, int manaUsed, int opponentHP, int shieldTimer, int poisonTimer,
              int rechargeTimer) {
            this.myHP = myHP;
            this.mana = mana;
